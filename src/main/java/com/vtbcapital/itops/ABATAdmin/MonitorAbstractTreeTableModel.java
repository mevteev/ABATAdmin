...
public abstract class MonitorAbstractTreeTableModel implements
		MonitorTreeTableModel {
	...
	public MonitorAbstractTreeTableModel(Object root) {
		this.root = root;
	}
	...
	private void fireTreeNode(int changeType, Object source, Object[] path,
