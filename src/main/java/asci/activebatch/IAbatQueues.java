...
@IID("{83A27C3D-3242-11D4-823C-00B0D011B7A1}")
public interface IAbatQueues extends Com4jObject, Iterable<Com4jObject> {
	// Methods:
	/**
	 * <p>
	...
	@VTID(8)
	@DefaultMethod
	asci.activebatch.IAbatQueue item(
	...
	@VTID(10)
	void add(asci.activebatch.IAbatQueue queueToAdd);
	...
	void remove(
			...
			@Optional @MarshalAs(NativeType.VARIANT) java.lang.Object flushQueueFirst);
