...
@IID("{83A27C49-3242-11D4-823C-00B0D011B7A1}")
public interface IAbatJobs extends Com4jObject, Iterable<Com4jObject> {
	// Methods:
	/**
	 * <p>
	...
	@VTID(8)
	@DefaultMethod
	asci.activebatch.IAbatJob item(
	...
	@VTID(10)
	void add(asci.activebatch.IAbatJob jobToAdd);
