...
@IID("{CEE3A07B-3969-42FC-BC39-CFA12DAF47AB}")
public interface IServiceLibraryLite extends Com4jObject {
	// Methods:
	/**
	 * <p>
   ...
   */
	...
	/**
	 * @return Returns a value of type asci.activebatch.IServiceLibrary
	 */

	@DISPID(13)
	// = 0xd. The runtime will prefer the VTID if present
	@VTID(19)
	asci.activebatch.IServiceLibrary getAbatObject();
